...
const defaultSwalOptions = {
  ...
  customClass: {
    ...
    title:
      "!p-0 !pt-3 !text-center sm:!text-left !text-base !font-semibold !leading-6 !text-gray-900 !ml-0 !pl-4 !pr-4 sm:!pr-6 sm:!pl-0 sm:!pt-6 sm:!ml-4 !col-start-1 sm:!col-start-2 !col-end-3",
    htmlContainer:
      "!mt-0 !pt-0 sm:!mt-0 !m-0 !text-center sm:!text-left !text-sm !text-gray-500 !pl-4 sm:!pl-0 !pr-4 !pb-4 sm:!pr-6 sm:!pb-4 sm:!ml-4 !col-start-1 sm:!col-start-2 !col-end-3",
    actions:
...
if (window.Swal) {
  window.Swal = window.Swal.mixin(defaultSwalOptions);
}
