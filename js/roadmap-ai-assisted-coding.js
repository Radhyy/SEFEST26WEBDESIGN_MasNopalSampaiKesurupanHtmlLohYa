const roadmapData = [
  {
    main: {
      ...
      desc: "Memahami bagaimana Large Language Models (LLM) bekerja dan batasan konteksnya (Context Windows & Tokens).",
    },
    left: [],
    right: [
      { id: "llm_mechanics", title: "How LLMs Work" },
      { id: "context_windows", title: "Context Windows & Tokens" },
      { id: "ai_limitations", title: "AI Limitations & Hallucinations" },
    ],
  },
  {
    main: {
      ...
      desc: "Teknik menyusun instruksi yang efektif agar AI menghasilkan kode yang akurat.",
    },
    left: [
      { id: "zero_few_shot", title: "Zero-shot & Few-shot", badge: "green" },
      { id: "chain_of_thought", title: "Chain of Thought (CoT)", badge: "purple" },
    ],
    right: [
      { id: "role_prompting", title: "Role Prompting", badge: "purple" },
      { id: "system_prompts", title: "System Prompts", badge: "green" },
    ],
  },
  {
    main: {
      ...
      desc: "Plugin dan ekstensi AI yang berjalan di dalam IDE tradisional seperti VS Code.",
    },
    left: [
      {
        id: "ai_projects",
        title: "Coding Exercises",
        desc: "Coba generate boilerplate dan unit test otomatis menggunakan Copilot.",
        isProjectBox: true,
      },
    ],
    right: [
      { id: "github_copilot", title: "GitHub Copilot", badge: "purple" },
      { id: "codeium", title: "Codeium", badge: "green" },
      { id: "tabnine", title: "Tabnine", badge: "purple" },
    ],
  },
  {
    main: {
      ...
      desc: "Code editor generasi baru yang dibangun secara native dengan integrasi AI mendalam.",
    },
    left: [{ id: "cursor", title: "Cursor", badge: "green" }, { id: "windsurf", title: "Windsurf", badge: "purple" }],
    right: [
      { id: "zed_ai", title: "Zed AI", badge: "green" },
      { id: "pearai", title: "PearAI", badge: "purple" },
    ],
  },
  {
    main: {
      id: "ai_chatbots",
      title: "Web Chatbots for Devs",
      desc: "Chatbot AI berbasis web untuk membantu developer coding, debugging, dan belajar tanpa setup lokal.",
    },
    left: [
      { id: "claude", title: "Claude 3.5 Sonnet", badge: "purple" },
    ],
    right: [
      { id: "chatgpt", title: "ChatGPT (GPT-4o)", badge: "green" },
    ],
  },
  {
    ...
    left: [
      {
        id: "refactoring_projects",
        title: "Refactoring Projects",
        desc: "Gunakan fitur 'Composer' di Cursor untuk me-refactor file codebase lama.",
        isProjectBox: true,
      },
    ],
    right: [],
  },
  {
    main: {
      id: "agentic_coding",
      title: "Agentic Coding & MCP",
      desc: "Sistem AI agen yang bisa berpikir, merencanakan, dan mengeksekusi kode secara mandiri.",
    },
    left: [
      { id: "cline", title: "Cline (formerly Claude Dev)", badge: "green" },
      { id: "devin", title: "Devin / OpenDevin", badge: "purple" },
    ],
    right: [
      { id: "mcp_protocol", title: "Model Context Protocol (MCP)", badge: "green", isRightHeading: true },
      { id: "auto_gpt", title: "AutoGPT / BabyAGI", badge: "purple" },
    ],
  },
  {
    main: {
      id: "ai_in_cicd",
      title: "AI in Testing & CI/CD",
      desc: "Mengotomatiskan review kode dan pembuatan tes dengan AI langsung di pipeline.",
    },
    left: [
      { id: "ai_code_review", title: "AI Pull Request Reviewers", badge: "green" },
      { id: "test_gen", title: "Automated Test Generation", badge: "purple" },
    ],
    right: [
      { id: "snyk_ai", title: "Snyk DeepCode AI", badge: "purple" },
      { id: "github_adv_sec", title: "GitHub Advanced Security AI", badge: "green" },
    ],
  },
  {
    main: {
...
async function fetchMateri(filename) {
  ...
  try {
    const res = await fetch(`../../../materi/aiasistencoding/${encodeURIComponent(filename)}`);
    if (res.ok) {
...
const nodeMapping = {
  // AI Coding Fundamentals — file: "AI Coding Fundamentals.json"
  "ai_coding_basics": { file: "AI Coding Fundamentals.json", key: "AI_Coding_Fundamentals" },
  "llm_mechanics": { file: "AI Coding Fundamentals.json", key: "How_LLMs_Work" },
  "context_windows": { file: "AI Coding Fundamentals.json", key: "Context_Windows_and_Tokens" },
  "ai_limitations": { file: "AI Coding Fundamentals.json", key: "AI_Limitations_and_Hallucinations" },

  // Prompt Engineering for Devs — file: "Prompt Engineering for Devs.json"
  "prompt_eng": { file: "Prompt Engineering for Devs.json", key: "Prompt_Engineering" },
  "zero_few_shot": { file: "Prompt Engineering for Devs.json", key: "Prompt_Engineering" },
  "chain_of_thought": { file: "Prompt Engineering for Devs.json", key: "Prompt_Engineering" },
  "role_prompting": { file: "Prompt Engineering for Devs.json", key: "Prompt_Engineering" },
  "system_prompts": { file: "Prompt Engineering for Devs.json", key: "Prompt_Engineering" },

  // AI Code Assistants — file: "aicodeasistent.json"
  "ai_extensions": { file: "aicodeasistent.json", key: "AI_Code_Assistants" },
  "github_copilot": { file: "aicodeasistent.json", key: "GitHub_Copilot" },
  "codeium": { file: "aicodeasistent.json", key: "Codeium" },
  "tabnine": { file: "aicodeasistent.json", key: "Tabnine" },

  // AI-Native IDEs — file: "AI-Native IDEs.json"
  "ai_native_ides": { file: "AI-Native IDEs.json", key: "AI_Native_IDEs" },
  "cursor": { file: "AI-Native IDEs.json", key: "Cursor" },
  "windsurf": { file: "AI-Native IDEs.json", key: "Windsurf" },
  "zed_ai": { file: "AI-Native IDEs.json", key: "Zed_AI" },
  "pearai": { file: "AI-Native IDEs.json", key: "PearAI" },

  // Web Chatbots for Devs — file: "Web Chatbots for Devs.json"
  "ai_chatbots": { file: "Web Chatbots for Devs.json", key: "Web_Chatbots_for_Devs" },
  "claude": { file: "Web Chatbots for Devs.json", key: "Claude_3_5_Sonnet" },
  "chatgpt": { file: "Web Chatbots for Devs.json", key: "ChatGPT_GPT_4o" },

  // Agentic Coding & MCP — file: "Agentic Coding & MC.json"
  "agentic_coding": { file: "Agentic Coding & MC.json", key: "Agentic_Coding_and_MCP" },
  "cline": { file: "Agentic Coding & MC.json", key: "Cline_Claude_Dev" },
  "devin": { file: "Agentic Coding & MC.json", key: "Devin_OpenDevin" },
  "mcp_protocol": { file: "Agentic Coding & MC.json", key: "Model_Context_Protocol_MCP" },
  "auto_gpt": { file: "Agentic Coding & MC.json", key: "AutoGPT_BabyAGI" },

  // AI in Testing & CI/CD — file: "ai in testing and cicd.json"
  "ai_in_cicd": { file: "ai in testing and cicd.json", key: "AI_in_Testing_and_CI_CD" },
  "ai_code_review": { file: "ai in testing and cicd.json", key: "AI_Pull_Request_Reviewers" },
  "test_gen": { file: "ai in testing and cicd.json", key: "Automated_Test_Generation" },
  "snyk_ai": { file: "ai in testing and cicd.json", key: "Snyk_DeepCode_AI" },
  "github_adv_sec": { file: "ai in testing and cicd.json", key: "GitHub_Advanced_Security_AI" }
};
